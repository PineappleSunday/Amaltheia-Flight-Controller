...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  if(hi2c->Instance==I2C1)
  {
    ...
    PB9     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(LSM303_GPIO_Port, LSM303_Pin);

    HAL_GPIO_DeInit(LSM303B9_GPIO_Port, LSM303B9_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI1)
  {
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, SCK_I3G4250D_Pin|MISO_I3G4250D_Pin|MOSI_I3G4250D_Pin);
  ...
  else if(hspi->Instance==SPI5)
  {
    ...
    PE14     ------> SPI5_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_0|SPI5_NSS_Pin);
